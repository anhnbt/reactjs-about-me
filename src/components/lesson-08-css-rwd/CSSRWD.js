...
`}
                                ...
                                <div className="">
                                    ...
                                    <ul className="list-inside list-disc text-lg">
                                        ...
                                        <li>Các phần tử được chia dựa vào phần trăm chiều rộng. Ví dụ, một phần tử chiếm
                                            4 cột sẽ rộng khoảng 33.33% nếu có 12 cột.
                                        </li>
                                        <li>Phương pháp này thường sử dụng float để sắp xếp các phần tử, vì vậy bạn sẽ
                                            cần thêm clearfix để tránh các vấn đề liên quan đến float.
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
`}
                                    ...
                                    <ul className="list-inside list-disc text-lg">
                                        <li><strong>Media Type</strong>: Loại thiết bị (ví dụ: screen, print).</li>
                                        <li>
                                            <strong>Media Feature</strong>: Đặc tính của thiết bị (ví dụ: min-width,
                                            orientation).
                                        </li>
                                    </ul>
                                </div>
